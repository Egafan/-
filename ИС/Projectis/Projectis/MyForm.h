...
namespace Projectis {
    ...
    public:
        MyForm(void) {
            ...
            listBox1->Items->Add("Конференция 1");
            listBox1->Items->Add("Конференция 2");
            listBox1->Items->Add("Конференция 3");
    ...
    private: System::Void addButton_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        if (addUserForm->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
            ...
            if (listBox1->SelectedItem != nullptr) {
                ...
                item->Checked = false;  // Устанавливаем флажок изначально в невыбранный
